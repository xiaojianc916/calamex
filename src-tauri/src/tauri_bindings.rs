...
use crate::commands::{
    attachment, builtin_agent, agent_webview, ai, format, git, script_run, search, shell_tools,
    skills, ssh, window, window_stage, workspace_fs, workspace_watcher,
};
use crate::launch;
...
pub fn builder() -> Builder<tauri::Wry> {
    Builder::<tauri::Wry>::new()
        ...
        .commands(collect_commands![
            ...
            builtin_agent::acp_host_health,
            builtin_agent::acp_host_restart,
            builtin_agent::acp_host_warmup,
            builtin_agent::acp_prompt,
            builtin_agent::acp_restore_checkpoint,
