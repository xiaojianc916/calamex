...
import { presentAppError } from '@/utils/error/error-presenter';
...
vi.mock('@/utils/error/error-dialog', async (importOriginal) => {
  const original = await importOriginal<typeof import('@/utils/error/error-dialog')>();
  return {
    ...original,
...
vi.mock('@/utils/error/error-toast', async (importOriginal) => {
  const original = await importOriginal<typeof import('@/utils/error/error-toast')>();
  return {
    ...original,
