...
fill="currentColor"
        ...
        <button
type="button" class="icon-button app-tooltip-target border border-transparent" data-tooltip="AI 助手"
          data-tooltip-placement="bottom" aria-label="AI 助手" @click="$emit('select-sidebar-view', 'ai')">
          <svg
