...
import WorkspaceTreeRow from '@/components/workbench/sidebar/explorer/WorkspaceTreeRow.vue';
...
} from '@/components/workbench/sidebar/explorer/workspace-tree-model';
