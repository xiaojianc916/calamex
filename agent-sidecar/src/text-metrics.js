 ...
 */
export const countTextChars = (value) => {
    let count = 0;
 ...
 */
export const measureText = (value) => {
    let charCount = 0;
...
export const stringifyForJson = (value) => {
    try {
...
export const countJsonChars = (value) => countTextChars(stringifyForJson(value));
/**
 ...
 */
export const estimateInputTokensByChars = (value) => measureText(value).tokenEstimate;
