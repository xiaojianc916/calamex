...
export const DEFAULT_MASTRA_LOG_FILE = './.builtin-agent/mastra.log';
export const DEFAULT_EXECUTION_AGENT_ID = 'calamex-builtin-agent';
export const DEFAULT_EXECUTION_AGENT_NAME = 'Calamex Agent Sidecar';
export const DEFAULT_VALIDATOR_AGENT_ID = 'calamex-builtin-agent-validator';
export const DEFAULT_REPLANNER_AGENT_ID = 'calamex-builtin-agent-replanner';
